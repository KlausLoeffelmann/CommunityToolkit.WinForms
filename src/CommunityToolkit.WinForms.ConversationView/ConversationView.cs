...
public partial class ConversationView : BlazorWebView
{
    ...
    {
        if (e.PropertyName == nameof(ConversationViewModel.Headline))
        {
            OnConversationTitleChanged(new ConversationTitleChangedEventArgs(_viewModel.Headline));
        }
    }
    ...
    {
        get => _viewModel.Headline;
        set
        {
            if (_viewModel is not null)
            {
                _viewModel.Headline = value!;
            }
        }
    }
    ...
    public void FromJson(string json)
    {
        ...
        try
        {
            ...
            _viewModel.Headline = tempModel.Headline;
