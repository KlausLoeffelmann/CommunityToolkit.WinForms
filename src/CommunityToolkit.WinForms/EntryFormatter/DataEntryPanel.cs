...
public partial class DataEntryPanel : Panel, IExtenderProvider
{
    private readonly Dictionary<TextBox, DataEntryExtenderProperties> _propertyStorage = [];
    ...
    private DataEntryExtenderProperties EnsureProperties(TextBox textBox)
    {
        if (!_propertyStorage.TryGetValue(textBox, out DataEntryExtenderProperties? value))
        {
            value = new DataEntryExtenderProperties(null, DefaultFocusColor, DefaultErrorColor);
    ...
    {
        DataEntryExtenderProperties properties = null!;
    ...
    private async Task<object?> GetObjectValueAsync(TextBox textBox, DataEntryExtenderProperties properties)
    {
    ...
    private async Task SetObjectValueAsync(TextBox textBox, DataEntryExtenderProperties properties, object? value)
    {
    ...
    private void TextBox_GotFocus(object? sender, EventArgs e)
    {
        ...
        DataEntryExtenderProperties properties = _propertyStorage[textBox];
    ...
    private void HandleFocusEmphasizing(TextBox textBox, DataEntryExtenderProperties properties, bool savePreviousColorState)
    {
    ...
    private async void TextBox_Validating(object? sender, CancelEventArgs e)
    {
        ...
        if (properties.FormatterComponent is IDataEntryFormatterComponent dataEntryFormatter)
        {
    ...
    private async Task<bool> TryCommitInputAsync(DataEntryExtenderProperties properties, TextBox textBox)
    {
        if (properties.FormatterComponent is IDataEntryFormatterComponent dataEntryFormatter)
        {
    ...
    private async static Task UpdateDisplayAsync(DataEntryExtenderProperties properties, TextBox textBox)
    {
